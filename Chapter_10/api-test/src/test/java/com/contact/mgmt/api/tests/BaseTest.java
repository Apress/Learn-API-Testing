...
import com.contact.mgmt.api.auth.Authentication;
import com.contact.mgmt.api.config.ApplicationContext;
import com.contact.mgmt.api.request.RequestProcessor;
import com.contact.mgmt.api.response.ResponseProcessor;
...
public class BaseTest {
  ...
  /* get the token insider the test script
   * to validation the auth payload
   */
  protected String getJwtToken() {
    return jwtToken;
  }

  /* set JWT token from the test script
