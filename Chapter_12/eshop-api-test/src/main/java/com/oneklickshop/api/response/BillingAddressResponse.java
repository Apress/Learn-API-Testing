 ...
 * @author Jagdeep Jain
 */
public abstract class BillingAddressResponse implements ResponseMarker {
  final Logger log = LogManager.getLogger(this.getClass());
  private Response response;

  public abstract BillingAddress getBillingAddress() throws InvalidResponseException;

  public Response getResponse() {
    return this.response;
  }

  public BillingAddressResponse setResponse(Response response) {
